...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/Agrume-iOS10.0/Agrume.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/FacebookCore-iOS10.0/FacebookCore.framework"
  install_framework "$BUILT_PRODUCTS_DIR/FacebookLogin-iOS10.0/FacebookLogin.framework"
